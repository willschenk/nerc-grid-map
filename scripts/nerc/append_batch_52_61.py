#!/usr/bin/env python3
"""Append geocoded records for research-queue lines 511-610 (batches 52-61)."""
import json
...
FIXES = {
    "NCR13474": {
        ...
        "source_url": None,
        "notes": "Strata Solar Services GOP; corporate HQ Durham NC (portfolio O&M).",
    },
    "NCR13305": {
        "confidence": "MEDIUM",
        "source": "parent_company_inference",
        "source_url": None,
        "notes": "SR EPC GOP; Silicon Ranch corporate HQ Nashville TN.",
    },
    "NCR00070": {
        "confidence": "MEDIUM",
        "source": "official_website",
        "source_url": None,
        "notes": "SEPA federal power marketing; DOE Southeastern region office Atlanta GA.",
    },
}
...
def main():
    ...
    expected = [queue[i] for i in range(510, 610)]
