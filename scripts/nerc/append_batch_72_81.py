#!/usr/bin/env python3
"""Append geocoded records for research-queue lines 711-810 (batches 72-81)."""
import json
...
FIXES = {
    "NCR13036": {
        ...
        "source_url": None,
        "notes": "esVolta merchant storage operator; HQ Irvine CA (outside TRE); Texas assets.",
    },
}
...
def main():
    ...
    expected = [queue[i] for i in range(710, 810)]
